...
function getEndpoints(deviceAddress, endpoints)
{
   ...
   endpoints.addEndpoint("2", " Sensor Humedad", endpointType.humiditySensor);
   endpoints.addEndpoint("3", "Sensor Ruido", endpointType.genericSensor);
   endpoints.addEndpoint("4", "PM1", endpointType.ppmConcentrationSensor);
}
